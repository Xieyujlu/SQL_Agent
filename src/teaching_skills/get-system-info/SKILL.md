...
3. **执行查询命令**：
   - 优先使用：`py teaching_skills/windows-system-info/get_system_info.py`
   - 或使用：`python3 teaching_skills/windows-system-info/get_system_info.py`
   - 或使用：`python teaching_skills/windows-system-info/get_system_info.py`

## 快捷命令
如果确定当前是项目根目录，可以直接使用（按优先级）：
- `py teaching_skills/windows-system-info/get_system_info.py`
- `python3 teaching_skills/windows-system-info/get_system_info.py`
